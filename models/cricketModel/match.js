...
const MatchSchema = new Schema({
  ...
  innings: [{
    ...
    battingStats: [{
      ...
      dismissalType: {
        type: String,
        enum: ["not_out", "bowled", "caught", "run_out", "stumped", "lbw", "hit_wicket", "retired_hurt", "retired_out", "obstructing_field", "timed_out", "handling_ball", "retired"]
      },
  ...
  commentary: [{
    ...
    type: {
      type: String,
      enum: ["regular", "wicket", "boundary", "six", "milestone", "start", "end", "drinks", "rain", "dls", "review"]
    },
    time: {
      type: Date,
      default: Date.now
...
// Virtual property for extras total calculation
